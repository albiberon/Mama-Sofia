...
function Navbar() {
    ...
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item active">
        <Link to="/mission" className="nav-link">API</Link>
      </li>
      <li className="nav-item active">
        <Link to="/mission" className="nav-link">Disclaimer</Link>
      </li>
    </ul>
    ...
    <ul className="navbar-nav mr-auto">
      <li className="nav-item">
        <a className="nav-link" href="#"><svg className="bi bi-search" width="1.5em" height="1.5em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
