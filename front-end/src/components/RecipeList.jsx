...
const Recipes = [
    ...
    },
    {
        ...
        preparation: `Bring a large pan of water to the boil and cook the gnocchi following pack instructions. When they float to the top of the pan, they are ready. Drain and set aside.
    ...
    {
        name: "Pea & leek open lasagne",
        imgURL: "https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/09/pea-leek-open-lasagne.jpg",
        shortDescription: "Make this healthy pea and leek lasagne in just 25 minutes.",
        preparation: `Put a frying pan over a medium heat. Pour in the oil and add the leeks, garlic and a pinch of salt. Cook, stirring occasionally, until collapsed and soft. 
    Meanwhile, bring a pan of water to the boil.Tip the peas and kale into the pan with the leeks and add a splash of water. Cook until the kale has wilted and peas are defrosted. 
    Turn down the heat to low. Stir in the mustard, crème fraîche and ¾ of the lemon zest. Add enough water to make a sauce. Give everything a good mix and season to taste. 
    Drop the lasagne into the water and cook following pack instructions, then drain well. Put one lasagne sheet on each plate, top with half the leek and pea mix then layer up the second lasagne sheet and the remaining greens. 
    Scatter over the remaining lemon zest and add a good grinding of black pepper.`,
        category: "lunch",
        ingredients: [
            `2 tbsp rapeseed oil`,
    ...
    },
    {
        ...
        shortDescription: "Pack four of your 5-a-day into these tasty veggie burgers with barbecued halloumi.",
        preparation: `Heat the barbecue. Put the cabbage, carrot, radish and coriander in a bowl. Pour over the lime juice, add ½ tbsp oil and the chilli flakes, then season with salt and pepper. Give everything a good mix with your hands. This can be done a few hours before and kept in the fridge.
    ...
    },
    {
        ...
        shortDescription: "Skip the duck and serve reader Anthea Hawdon's vegetarian pancakes with hoisin sauce.",
    ...
    },
    {
        ...
        shortDescription: "This casual meat-free breakfast is a cheap and cheerful way to fill up your friends.",
...
function RecipeList() {
    return <div className="container-fluid flex" style={grayBackground} id="recipe-list">
        <RecipeSearchBar />
        <div className="container space-top-bottom">
            <div className="row">
                ...
                <RecipeCard
                    ...
                    name={Recipes[0].name}
                    shortDescription={Recipes[0].shortDescription}
                    category={Recipes[0].category}
                />

                <RecipeCard
                    img="https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe_images/coconut-squash-dhansak.jpg"
                    name="Coconut & squash dhansak"
                    shortDescription="This easy vegetarian curry is perfect for a healthy dinner."
                />

                <RecipeCard
                    img="https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/12/veggie-fajitas.jpg"
                    name="Vegetarian fajitas"
                    shortDescription="Looking for a quick and easy veggie family meal? Try these meat-free fajitas."
                />

                <RecipeCard
                    img="https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2016/08/gnocchi-with-mushrooms.jpg"
                    name="Gnocchi with mushrooms"
                    shortDescription="Soft, creamy goat's cheese or a deliciously strong blue cheese both work well."
                />

                <RecipeCard
                    img="https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2016/07/sweetcorn-courgette-fritters.jpg"
                    name="Sweetcorn & courgette fritters"
                    shortDescription="An easy, vegetarian fritter you can have on the table in 25 minutes."
                />

                <RecipeCard
                    img="https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/09/pea-leek-open-lasagne.jpg"
                    name="Pea & leek open lasagne"
                    shortDescription="Make this healthy pea and leek lasagne in just 25 minutes."
                />
            </div>
